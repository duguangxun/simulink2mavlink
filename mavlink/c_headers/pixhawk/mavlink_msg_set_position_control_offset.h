 ...
 */
static __inline uint16_t mavlink_msg_set_position_control_offset_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_set_position_control_offset_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_set_position_control_offset_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_set_position_control_offset_t* set_position_control_offset)
{
 ...
 * @param set_position_control_offset C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_set_position_control_offset_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_set_position_control_offset_t* set_position_control_offset)
{
...
static __inline void mavlink_msg_set_position_control_offset_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, float x, float y, float z, float yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SET_POSITION_CONTROL_OFFSET_LEN];
	_mav_put_float(buf, 0, x);
 ...
 */
static __inline void mavlink_msg_set_position_control_offset_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, float x, float y, float z, float yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return System ID
 */
static __inline uint8_t mavlink_msg_set_position_control_offset_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static __inline uint8_t mavlink_msg_set_position_control_offset_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_set_position_control_offset_get_x(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_set_position_control_offset_get_y(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_set_position_control_offset_get_z(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_set_position_control_offset_get_yaw(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_set_position_control_offset_decode(const mavlink_message_t* msg, mavlink_set_position_control_offset_t* set_position_control_offset)
{
