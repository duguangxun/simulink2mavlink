 ...
 */
static __inline uint16_t mavlink_msg_detection_stats_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_detection_stats_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_detection_stats_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_detection_stats_t* detection_stats)
{
 ...
 * @param detection_stats C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_detection_stats_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_detection_stats_t* detection_stats)
{
...
static __inline void mavlink_msg_detection_stats_send(mavlink_channel_t chan, uint32_t detections, uint32_t cluster_iters, float best_score, int32_t best_lat, int32_t best_lon, int32_t best_alt, uint32_t best_detection_id, uint32_t best_cluster_id, uint32_t best_cluster_iter_id, uint32_t images_done, uint32_t images_todo, float fps)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_DETECTION_STATS_LEN];
	_mav_put_uint32_t(buf, 0, detections);
 ...
 */
static __inline uint32_t mavlink_msg_detection_stats_get_detections(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint32_t mavlink_msg_detection_stats_get_cluster_iters(const mavlink_message_t* msg)
{
 ...
 * @return Best score
 */
static __inline float mavlink_msg_detection_stats_get_best_score(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_detection_stats_get_best_lat(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_detection_stats_get_best_lon(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_detection_stats_get_best_alt(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint32_t mavlink_msg_detection_stats_get_best_detection_id(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint32_t mavlink_msg_detection_stats_get_best_cluster_id(const mavlink_message_t* msg)
{
 ...
 * @return Best cluster ID
 */
static __inline uint32_t mavlink_msg_detection_stats_get_best_cluster_iter_id(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint32_t mavlink_msg_detection_stats_get_images_done(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint32_t mavlink_msg_detection_stats_get_images_todo(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_detection_stats_get_fps(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_detection_stats_decode(const mavlink_message_t* msg, mavlink_detection_stats_t* detection_stats)
{
