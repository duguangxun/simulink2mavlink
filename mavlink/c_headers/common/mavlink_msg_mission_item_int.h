 ...
 */
static __inline uint16_t mavlink_msg_mission_item_int_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_mission_item_int_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_mission_item_int_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_mission_item_int_t* mission_item_int)
{
 ...
 * @param mission_item_int C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_mission_item_int_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_mission_item_int_t* mission_item_int)
{
...
static __inline void mavlink_msg_mission_item_int_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t seq, uint8_t frame, uint16_t command, uint8_t current, uint8_t autocontinue, float param1, float param2, float param3, float param4, int32_t x, int32_t y, float z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_MISSION_ITEM_INT_LEN];
	_mav_put_float(buf, 0, param1);
 ...
 */
static __inline void mavlink_msg_mission_item_int_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t seq, uint8_t frame, uint16_t command, uint8_t current, uint8_t autocontinue, float param1, float param2, float param3, float param4, int32_t x, int32_t y, float z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return System ID
 */
static __inline uint8_t mavlink_msg_mission_item_int_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static __inline uint8_t mavlink_msg_mission_item_int_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_mission_item_int_get_seq(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_mission_item_int_get_frame(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_mission_item_int_get_command(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_mission_item_int_get_current(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_mission_item_int_get_autocontinue(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_mission_item_int_get_param1(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_mission_item_int_get_param2(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_mission_item_int_get_param3(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_mission_item_int_get_param4(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_mission_item_int_get_x(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_mission_item_int_get_y(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_mission_item_int_get_z(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_mission_item_int_decode(const mavlink_message_t* msg, mavlink_mission_item_int_t* mission_item_int)
{
