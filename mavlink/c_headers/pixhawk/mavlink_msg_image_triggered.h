 ...
 */
static __inline uint16_t mavlink_msg_image_triggered_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_image_triggered_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_image_triggered_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_image_triggered_t* image_triggered)
{
 ...
 * @param image_triggered C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_image_triggered_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_image_triggered_t* image_triggered)
{
...
static __inline void mavlink_msg_image_triggered_send(mavlink_channel_t chan, uint64_t timestamp, uint32_t seq, float roll, float pitch, float yaw, float local_z, float lat, float lon, float alt, float ground_x, float ground_y, float ground_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_IMAGE_TRIGGERED_LEN];
	_mav_put_uint64_t(buf, 0, timestamp);
 ...
 */
static __inline void mavlink_msg_image_triggered_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, uint32_t seq, float roll, float pitch, float yaw, float local_z, float lat, float lon, float alt, float ground_x, float ground_y, float ground_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return Timestamp
 */
static __inline uint64_t mavlink_msg_image_triggered_get_timestamp(const mavlink_message_t* msg)
{
 ...
 * @return IMU seq
 */
static __inline uint32_t mavlink_msg_image_triggered_get_seq(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_roll(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_pitch(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_yaw(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_local_z(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_lat(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_lon(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_alt(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_ground_x(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_ground_y(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_triggered_get_ground_z(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_image_triggered_decode(const mavlink_message_t* msg, mavlink_image_triggered_t* image_triggered)
{
