 ...
 */
static __inline uint16_t mavlink_msg_image_available_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_image_available_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_image_available_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_image_available_t* image_available)
{
 ...
 * @param image_available C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_image_available_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_image_available_t* image_available)
{
...
static __inline void mavlink_msg_image_available_send(mavlink_channel_t chan, uint64_t cam_id, uint8_t cam_no, uint64_t timestamp, uint64_t valid_until, uint32_t img_seq, uint32_t img_buf_index, uint16_t width, uint16_t height, uint16_t depth, uint8_t channels, uint32_t key, uint32_t exposure, float gain, float roll, float pitch, float yaw, float local_z, float lat, float lon, float alt, float ground_x, float ground_y, float ground_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_IMAGE_AVAILABLE_LEN];
	_mav_put_uint64_t(buf, 0, cam_id);
 ...
 * @return Camera id
 */
static __inline uint64_t mavlink_msg_image_available_get_cam_id(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_image_available_get_cam_no(const mavlink_message_t* msg)
{
 ...
 * @return Timestamp
 */
static __inline uint64_t mavlink_msg_image_available_get_timestamp(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint64_t mavlink_msg_image_available_get_valid_until(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint32_t mavlink_msg_image_available_get_img_seq(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint32_t mavlink_msg_image_available_get_img_buf_index(const mavlink_message_t* msg)
{
 ...
 * @return Image width
 */
static __inline uint16_t mavlink_msg_image_available_get_width(const mavlink_message_t* msg)
{
 ...
 * @return Image height
 */
static __inline uint16_t mavlink_msg_image_available_get_height(const mavlink_message_t* msg)
{
 ...
 * @return Image depth
 */
static __inline uint16_t mavlink_msg_image_available_get_depth(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_image_available_get_channels(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint32_t mavlink_msg_image_available_get_key(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint32_t mavlink_msg_image_available_get_exposure(const mavlink_message_t* msg)
{
 ...
 * @return Camera gain
 */
static __inline float mavlink_msg_image_available_get_gain(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_roll(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_pitch(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_yaw(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_local_z(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_lat(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_lon(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_alt(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_ground_x(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_ground_y(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_image_available_get_ground_z(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_image_available_decode(const mavlink_message_t* msg, mavlink_image_available_t* image_available)
{
