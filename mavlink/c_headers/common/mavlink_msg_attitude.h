 ...
 */
static __inline uint16_t mavlink_msg_attitude_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_attitude_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_attitude_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_attitude_t* attitude)
{
 ...
 * @param attitude C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_attitude_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_attitude_t* attitude)
{
...
static __inline void mavlink_msg_attitude_send(mavlink_channel_t chan, uint32_t time_boot_ms, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_ATTITUDE_LEN];
	_mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static __inline void mavlink_msg_attitude_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float roll, float pitch, float yaw, float rollspeed, float pitchspeed, float yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static __inline uint32_t mavlink_msg_attitude_get_time_boot_ms(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_attitude_get_roll(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_attitude_get_pitch(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_attitude_get_yaw(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_attitude_get_rollspeed(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_attitude_get_pitchspeed(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_attitude_get_yawspeed(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_attitude_decode(const mavlink_message_t* msg, mavlink_attitude_t* attitude)
{
