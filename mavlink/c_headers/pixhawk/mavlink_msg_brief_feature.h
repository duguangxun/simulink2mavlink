 ...
 */
static __inline uint16_t mavlink_msg_brief_feature_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_brief_feature_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_brief_feature_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_brief_feature_t* brief_feature)
{
 ...
 * @param brief_feature C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_brief_feature_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_brief_feature_t* brief_feature)
{
...
static __inline void mavlink_msg_brief_feature_send(mavlink_channel_t chan, float x, float y, float z, uint8_t orientation_assignment, uint16_t size, uint16_t orientation, const uint8_t *descriptor, float response)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_BRIEF_FEATURE_LEN];
	_mav_put_float(buf, 0, x);
 ...
 */
static __inline void mavlink_msg_brief_feature_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float x, float y, float z, uint8_t orientation_assignment, uint16_t size, uint16_t orientation, const uint8_t *descriptor, float response)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static __inline float mavlink_msg_brief_feature_get_x(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_brief_feature_get_y(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_brief_feature_get_z(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_brief_feature_get_orientation_assignment(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_brief_feature_get_size(const mavlink_message_t* msg)
{
 ...
 * @return Orientation
 */
static __inline uint16_t mavlink_msg_brief_feature_get_orientation(const mavlink_message_t* msg)
{
 ...
 * @return Descriptor
 */
static __inline uint16_t mavlink_msg_brief_feature_get_descriptor(const mavlink_message_t* msg, uint8_t *descriptor)
{
 ...
 */
static __inline float mavlink_msg_brief_feature_get_response(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_brief_feature_decode(const mavlink_message_t* msg, mavlink_brief_feature_t* brief_feature)
{
