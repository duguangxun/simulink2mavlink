 ...
 */
static __inline uint16_t mavlink_msg_point_of_interest_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_point_of_interest_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_point_of_interest_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_point_of_interest_t* point_of_interest)
{
 ...
 * @param point_of_interest C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_point_of_interest_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_point_of_interest_t* point_of_interest)
{
...
static __inline void mavlink_msg_point_of_interest_send(mavlink_channel_t chan, uint8_t type, uint8_t color, uint8_t coordinate_system, uint16_t timeout, float x, float y, float z, const char *name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_POINT_OF_INTEREST_LEN];
	_mav_put_float(buf, 0, x);
 ...
 */
static __inline void mavlink_msg_point_of_interest_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t type, uint8_t color, uint8_t coordinate_system, uint16_t timeout, float x, float y, float z, const char *name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static __inline uint8_t mavlink_msg_point_of_interest_get_type(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_point_of_interest_get_color(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_point_of_interest_get_coordinate_system(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_point_of_interest_get_timeout(const mavlink_message_t* msg)
{
 ...
 * @return X Position
 */
static __inline float mavlink_msg_point_of_interest_get_x(const mavlink_message_t* msg)
{
 ...
 * @return Y Position
 */
static __inline float mavlink_msg_point_of_interest_get_y(const mavlink_message_t* msg)
{
 ...
 * @return Z Position
 */
static __inline float mavlink_msg_point_of_interest_get_z(const mavlink_message_t* msg)
{
 ...
 * @return POI name
 */
static __inline uint16_t mavlink_msg_point_of_interest_get_name(const mavlink_message_t* msg, char *name)
{
 ...
 */
static __inline void mavlink_msg_point_of_interest_decode(const mavlink_message_t* msg, mavlink_point_of_interest_t* point_of_interest)
{
