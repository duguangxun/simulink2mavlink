 ...
 */
static __inline uint16_t mavlink_msg_scaled_imu2_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_scaled_imu2_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_scaled_imu2_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_scaled_imu2_t* scaled_imu2)
{
 ...
 * @param scaled_imu2 C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_scaled_imu2_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_scaled_imu2_t* scaled_imu2)
{
...
static __inline void mavlink_msg_scaled_imu2_send(mavlink_channel_t chan, uint32_t time_boot_ms, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_SCALED_IMU2_LEN];
	_mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static __inline void mavlink_msg_scaled_imu2_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static __inline uint32_t mavlink_msg_scaled_imu2_get_time_boot_ms(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_scaled_imu2_get_xacc(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_scaled_imu2_get_yacc(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_scaled_imu2_get_zacc(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_scaled_imu2_get_xgyro(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_scaled_imu2_get_ygyro(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_scaled_imu2_get_zgyro(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_scaled_imu2_get_xmag(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_scaled_imu2_get_ymag(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_scaled_imu2_get_zmag(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_scaled_imu2_decode(const mavlink_message_t* msg, mavlink_scaled_imu2_t* scaled_imu2)
{
