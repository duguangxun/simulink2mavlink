 ...
 */
static __inline uint16_t mavlink_msg_local_position_ned_cov_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_local_position_ned_cov_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_local_position_ned_cov_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_local_position_ned_cov_t* local_position_ned_cov)
{
 ...
 * @param local_position_ned_cov C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_local_position_ned_cov_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_local_position_ned_cov_t* local_position_ned_cov)
{
...
static __inline void mavlink_msg_local_position_ned_cov_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint64_t time_utc, uint8_t estimator_type, float x, float y, float z, float vx, float vy, float vz, const float *covariance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_LOCAL_POSITION_NED_COV_LEN];
	_mav_put_uint64_t(buf, 0, time_utc);
 ...
 */
static __inline void mavlink_msg_local_position_ned_cov_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, uint64_t time_utc, uint8_t estimator_type, float x, float y, float z, float vx, float vy, float vz, const float *covariance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static __inline uint32_t mavlink_msg_local_position_ned_cov_get_time_boot_ms(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint64_t mavlink_msg_local_position_ned_cov_get_time_utc(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_local_position_ned_cov_get_estimator_type(const mavlink_message_t* msg)
{
 ...
 * @return X Position
 */
static __inline float mavlink_msg_local_position_ned_cov_get_x(const mavlink_message_t* msg)
{
 ...
 * @return Y Position
 */
static __inline float mavlink_msg_local_position_ned_cov_get_y(const mavlink_message_t* msg)
{
 ...
 * @return Z Position
 */
static __inline float mavlink_msg_local_position_ned_cov_get_z(const mavlink_message_t* msg)
{
 ...
 * @return X Speed
 */
static __inline float mavlink_msg_local_position_ned_cov_get_vx(const mavlink_message_t* msg)
{
 ...
 * @return Y Speed
 */
static __inline float mavlink_msg_local_position_ned_cov_get_vy(const mavlink_message_t* msg)
{
 ...
 * @return Z Speed
 */
static __inline float mavlink_msg_local_position_ned_cov_get_vz(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_local_position_ned_cov_get_covariance(const mavlink_message_t* msg, float *covariance)
{
 ...
 */
static __inline void mavlink_msg_local_position_ned_cov_decode(const mavlink_message_t* msg, mavlink_local_position_ned_cov_t* local_position_ned_cov)
{
