 ...
 */
static __inline uint16_t mavlink_msg_position_control_setpoint_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_position_control_setpoint_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_position_control_setpoint_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_position_control_setpoint_t* position_control_setpoint)
{
 ...
 * @param position_control_setpoint C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_position_control_setpoint_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_position_control_setpoint_t* position_control_setpoint)
{
...
static __inline void mavlink_msg_position_control_setpoint_send(mavlink_channel_t chan, uint16_t id, float x, float y, float z, float yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_POSITION_CONTROL_SETPOINT_LEN];
	_mav_put_float(buf, 0, x);
 ...
 */
static __inline void mavlink_msg_position_control_setpoint_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t id, float x, float y, float z, float yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static __inline uint16_t mavlink_msg_position_control_setpoint_get_id(const mavlink_message_t* msg)
{
 ...
 * @return x position
 */
static __inline float mavlink_msg_position_control_setpoint_get_x(const mavlink_message_t* msg)
{
 ...
 * @return y position
 */
static __inline float mavlink_msg_position_control_setpoint_get_y(const mavlink_message_t* msg)
{
 ...
 * @return z position
 */
static __inline float mavlink_msg_position_control_setpoint_get_z(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_position_control_setpoint_get_yaw(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_position_control_setpoint_decode(const mavlink_message_t* msg, mavlink_position_control_setpoint_t* position_control_setpoint)
{
