 ...
 */
static __inline uint16_t mavlink_msg_onboard_health_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_onboard_health_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_onboard_health_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_onboard_health_t* onboard_health)
{
 ...
 * @param onboard_health C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_onboard_health_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_onboard_health_t* onboard_health)
{
 ...
 */
static __inline uint32_t mavlink_msg_onboard_health_get_uptime(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_onboard_health_get_cpu_freq(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_onboard_health_get_cpu_load(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_onboard_health_get_ram_usage(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_onboard_health_get_ram_total(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_onboard_health_get_swap_usage(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_onboard_health_get_swap_total(const mavlink_message_t* msg)
{
 ...
 */
static __inline int8_t mavlink_msg_onboard_health_get_disk_health(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_onboard_health_get_disk_usage(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_onboard_health_get_disk_total(const mavlink_message_t* msg)
{
 ...
 * @return Temperature
 */
static __inline float mavlink_msg_onboard_health_get_temp(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_onboard_health_get_voltage(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_onboard_health_get_network_load_in(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_onboard_health_get_network_load_out(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_onboard_health_decode(const mavlink_message_t* msg, mavlink_onboard_health_t* onboard_health)
{
