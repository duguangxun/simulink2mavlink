 ...
 */
static __inline uint16_t mavlink_msg_raw_aux_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_raw_aux_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_raw_aux_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_raw_aux_t* raw_aux)
{
 ...
 * @param raw_aux C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_raw_aux_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_raw_aux_t* raw_aux)
{
...
static __inline void mavlink_msg_raw_aux_send(mavlink_channel_t chan, uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t vbat, int16_t temp, int32_t baro)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_RAW_AUX_LEN];
	_mav_put_int32_t(buf, 0, baro);
 ...
 */
static __inline void mavlink_msg_raw_aux_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t vbat, int16_t temp, int32_t baro)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static __inline uint16_t mavlink_msg_raw_aux_get_adc1(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_raw_aux_get_adc2(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_raw_aux_get_adc3(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_raw_aux_get_adc4(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_raw_aux_get_vbat(const mavlink_message_t* msg)
{
 ...
 */
static __inline int16_t mavlink_msg_raw_aux_get_temp(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_raw_aux_get_baro(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_raw_aux_decode(const mavlink_message_t* msg, mavlink_raw_aux_t* raw_aux)
{
