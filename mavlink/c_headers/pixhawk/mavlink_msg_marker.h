 ...
 */
static __inline uint16_t mavlink_msg_marker_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_marker_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_marker_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_marker_t* marker)
{
 ...
 * @param marker C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_marker_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_marker_t* marker)
{
...
static __inline void mavlink_msg_marker_send(mavlink_channel_t chan, uint16_t id, float x, float y, float z, float roll, float pitch, float yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_MARKER_LEN];
	_mav_put_float(buf, 0, x);
 ...
 */
static __inline void mavlink_msg_marker_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t id, float x, float y, float z, float roll, float pitch, float yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return ID
 */
static __inline uint16_t mavlink_msg_marker_get_id(const mavlink_message_t* msg)
{
 ...
 * @return x position
 */
static __inline float mavlink_msg_marker_get_x(const mavlink_message_t* msg)
{
 ...
 * @return y position
 */
static __inline float mavlink_msg_marker_get_y(const mavlink_message_t* msg)
{
 ...
 * @return z position
 */
static __inline float mavlink_msg_marker_get_z(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_marker_get_roll(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_marker_get_pitch(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_marker_get_yaw(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_marker_decode(const mavlink_message_t* msg, mavlink_marker_t* marker)
{
