 ...
 */
static __inline uint16_t mavlink_msg_param_map_rc_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_param_map_rc_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_param_map_rc_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_param_map_rc_t* param_map_rc)
{
 ...
 * @param param_map_rc C-struct to read the message contents from
 */
static __inline uint16_t mavlink_msg_param_map_rc_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, const mavlink_param_map_rc_t* param_map_rc)
{
...
static __inline void mavlink_msg_param_map_rc_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, const char *param_id, int16_t param_index, uint8_t parameter_rc_channel_index, float param_value0, float scale, float param_value_min, float param_value_max)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_PARAM_MAP_RC_LEN];
	_mav_put_float(buf, 0, param_value0);
 ...
 */
static __inline void mavlink_msg_param_map_rc_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, const char *param_id, int16_t param_index, uint8_t parameter_rc_channel_index, float param_value0, float scale, float param_value_min, float param_value_max)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 * @return System ID
 */
static __inline uint8_t mavlink_msg_param_map_rc_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static __inline uint8_t mavlink_msg_param_map_rc_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_param_map_rc_get_param_id(const mavlink_message_t* msg, char *param_id)
{
 ...
 */
static __inline int16_t mavlink_msg_param_map_rc_get_param_index(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_param_map_rc_get_parameter_rc_channel_index(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_param_map_rc_get_param_value0(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_param_map_rc_get_scale(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_param_map_rc_get_param_value_min(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_param_map_rc_get_param_value_max(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_param_map_rc_decode(const mavlink_message_t* msg, mavlink_param_map_rc_t* param_map_rc)
{
